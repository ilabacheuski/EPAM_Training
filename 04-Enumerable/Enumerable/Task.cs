...
namespace EnumerableTask {
    ...
    public class Task {
        ...
        public string GetStringOfSequence<T>(IEnumerable<T> data) {
            ...
            return string.Join(",", data.Select(x => x == null ? "null" : x.ToString())); //data.Count()==0? "" : data.Select(x=>x==null?"null":x.ToString()).Aggregate((i, j) => i+","+j).ToString();
        }
        ...
        public int GetCountOfStringsWithLengthEqualsTo3(IEnumerable<string> data) {
            ...
            return data.Where(x => (x==null ? false : x.Length == 3)).Distinct().Count();
        }
        ...
        public IEnumerable<string> GetStringsOnly(object[] data) {
            ...
            return data.Where(d => d?.GetType() == typeof(string)).Cast<string>().ToList();
        }
        ...
        public double GetAverageOfDoubleValues(IEnumerable<object> data) {
            ...
            return data.OfType<double>().DefaultIfEmpty<double>().Average();
        }
